...
def build(preview=False):
 ...
 urls=['', 'papers/','specials/','archive/','subscribe/']+['read/'+i['id']+'/' for i in issues]+[e['path'].removeprefix(PREFIX) for e in entries if e['type']!='news']
